...
for i, msg in enumerate(st.session_state.messages):
    ...
    with st.chat_message(msg["role"], avatar="🧑‍💻" if msg["role"] == "user" else "⚡"):
        ...
        # FITUR: TOMBOL COPY + TTS UNTUK JAWABAN AI
            ...
            with col2:
                ...
                if st.button("🔊 Dengerin", key=f"tts_{i}"):
                    with st.spinner("Bikin suara..."):
                        tts = gTTS(text=msg["content"], lang='id')
                        tts.save("temp.mp3")
...
if prompt or uploaded_file:
    ...
    if uploaded_file is not None:
        # Simpan file buat ditampilin, tapi yang dikirim ke API yang udah dikompres
        ...
        if app_mode == "🎨 Bikin Gambar":
            ...
            with st.spinner("Fanilla lagi mikir..."):
                try:
                    ...
                    # BUILD MESSAGES DENGAN MEMORY + VISION
                    messages_api = [{"role": "system", "content": SYSTEM_PROMPT}]

                    # Masukkan history chat terakhir 6 pesan biar ga kepanjangan
                    for msg in st.session_state.messages[-6:]:
                        if msg["role"] == "system": continue
                        if msg["type"] == "text":
                            messages_api.append({"role": msg["role"], "content": msg["content"]})
                        elif msg["type"] == "image_upload" and msg["role"] == "user":
                            # Kompres gambar terakhir doang
                    ...
                    st.rerun() # Rerun biar tombol copy+tts muncul
